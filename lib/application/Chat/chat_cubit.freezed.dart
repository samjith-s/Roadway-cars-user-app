...
/// @nodoc
mixin _$ChatState {
  List<Chat> get totalChats => throw _privateConstructorUsedError;
...
class _$_ChatState implements _ChatState {
  const _$_ChatState(
      {required final List<Chat> totalChats,
      required this.isLoading,
      required this.isError})
      : _totalChats = totalChats;

  final List<Chat> _totalChats;
  @override
  List<Chat> get totalChats {
  ...
  @override
  String toString() {
    return 'ChatState(totalChats: $totalChats, isLoading: $isLoading, isError: $isError)';
  }
...
abstract class _ChatState implements ChatState {
  const factory _ChatState(
      ...
      required final bool isError}) = _$_ChatState;
